...
def send_email(subject, body, recipients):
    ...
    gmail_password = 'rnwx mdjg woju uzpp'
        ...
        if current_price:
            ...
            if current_price < target_price:
                ...
                if email_alert:
                    ...
                    recipients = ['annamanenisai3015@gmail.com', '22r11a6746@gcet.edu.in']
                    send_email(subject, body, recipients)
            else:
                st.warning("❌ Price is still above target.")
        else:
            st.error("Failed to fetch the current price.")
    else:
        st.warning("Please provide both a valid URL and a target price.")
